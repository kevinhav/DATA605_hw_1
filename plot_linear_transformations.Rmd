...
This is also our characteristic polynomial, and as expected, the eigenvalues are 1, which we would expect of any identity matrix.
...
Since any vector of A is an eigenvector, we can say that the eigenvectors are linearly independent.
